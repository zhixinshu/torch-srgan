...
parser.add_argument('--train_dir',default='/nfs/bigdisk/zhshu/MegaFace_sub/up1024/res256/b_10')
parser.add_argument('--val_dir',default='/nfs/bigdisk/zhshu/MegaFace_sub/up1024/res256/valset')
parser.add_argument('--output_file',default='/nfs/bigdisk/zhshu/Datasets/mega_256_10.h5')
